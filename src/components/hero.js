        ...
        <div className="container px-4 mx-auto">
          <div className="flex flex-wrap xl:items-center -mx-4">
            <div className="w-full md:w-1/2 px-4 mb-16 md:mb-0">
              <h1 className="mb-6 text-3xl md:text-5xl lg:text-6xl leading-tight font-bold tracking-tight uppercase">
                The Portal
              </h1>
              <h3 className="mb-6 text-1xl md:text-1xl lg:text-3xl leading-tight font-bold tracking-tight uppercase">
